...
// use local DACs instead of global DACs so that we can calculate two arms differently.
...
/*
  ...
  //  double input2 = (2.737629663234212e-04*DACs[1]+1.0*0.0697023000)*0.85;
	...
	double input1 = (2.737629663234212e-04*(l_DACs[0])-1.153*0.041613800000000)*0.9; //1.16 1.0 new 1.183
    double input2 = (2.737629663234212e-04*(l_DACs[1])-0.9*0.0697023000)*1.0;  //0.9 1.0
    double input3 = (2.737629663234212e-04*(l_DACs[2])+0.4*0.039108200000000)*0.9; //0.4 1.0
